        ...
        VStack(alignment: .leading, spacing: 20) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                infoRow(
                    ...
                    text: "Zoomies reviews and closes unnecessary background apps while preserving your chosen launchers, Discord, recording apps and gaming peripherals."
                )

                infoRow(
                    icon: "arrow.triangle.2.circlepath.circle.fill",
                    title: "Restore apps when you're done",
                    text: "Closed apps can be restored at the end of your session. This is enabled by default and can be changed at any time from Zoomies Settings."
                )
                ...
                Link("View source & releases at zoomiesformacos.com", destination: URL(string: "http://www.zoomiesformacos.com")!)
                    .font(.subheadline)
                    .foregroundStyle(.secondary)
                    .padding(.top, 4)
            }
